...
#Cargamos de celeba las fotos
df = pd.read_csv('C:/Users/Administrador/PycharmProjects/pythonProject/list_attr_celeba.csv', sep=',', header=None)
df = df[1:]
print(df)
#exit()
...
#Reemplazamos para tener valores 0 y 1
...
#Convierte a matrices en un objeto
files = tf.data.Dataset.from_tensor_slices(df[0])
attributes = tf.data.Dataset.from_tensor_slices(x)
data = tf.data.Dataset.zip((files, attributes))
path_to_images = 'C:/Users/Administrador/PycharmProjects/pythonProject/archive/img_align_celeba/img_align_celeba/'



#El siguiente proceso es para cargar , unir, mormalizar entre otras cosas
